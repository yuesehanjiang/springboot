...
public class StringUtils {
     ...
     * @return
     */
    public static String verificationStr(String original, String nickname, String signature, String introduction,
            String trainContent) {
        if (original != null && original.length() > 100) {
            return "图片名字不能超过100个字符";
        }
        if (nickname != null && nickname.length() > 12) {
            return "用户名称不能超过12字符";
        }
        if (signature != null && signature.length() > 36) {
            return "个性签名不能超过36字符";
        }
        if (introduction != null && introduction.length() > 300) {
            return "个人简介不能超过300字符";
        }
        if (trainContent != null && trainContent.length() > 300) {
            return "训练介绍不能超过300字符";
        }
        return "success";
    }
    ...
    public static String replaceStr(String str) {
        if (str != null) {
            String s = str.replace("~", "").replace("%", "").replace("{", "").replace("}", "").replace("(", "")
    ...
    public static String getWeek() {
        return Calendar.getInstance().getDisplayName(Calendar.DAY_OF_WEEK, Calendar.SHORT, Locale.getDefault());
    }
     ...
     * @return
     */
    public static HashMap<String, Object> calculationPage(String pNum, String pSize) {
        HashMap<String, Object> map = new HashMap<String, Object>();
        ParameterUtil parameter = new ParameterUtil();
        parameter.setPageNum(pNum);
        parameter.setPageSize(pSize);
        int pageNum = (Integer.parseInt(parameter.getPageNum()) - 1) * Integer.parseInt(parameter.getPageSize());
    ...
    public static List<String> stringtoArr(String str) {
        ...
        List arrayList = new ArrayList(stringB);
        return arrayList;
    }
